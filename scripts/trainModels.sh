...
python scripts/train.py -k 10 -d yakindu-exercise -pd data/yakindu-exercise/ -s models/yakindu-exercise-finalModel.m -td models/yakindu-exercise-finalModel.details -e 50 -es trainloss -emf python -hi 64 -b 128
