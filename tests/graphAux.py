...
G_wo_ref_itself.add_node(1, type = 'EClass', ids = {1,2})
...
G_wo_ref.add_node(1, type = 'EClass', ids = {1})
G_wo_ref.add_node(2, type = 'EClass', ids = {2})
...
G_with_one_id.add_node(1, type = 'EClass', ids = {1})
...
pattern2_ref.add_node(0, type = ['EClass'], ids = {1})
pattern2_ref.add_node(1, type = 'EReference')
pattern2_ref.add_node(2, type = ['EClass'], ids = {2})
...
pattern1_st.add_node(0, type = ['EClass'], ids = {1})
